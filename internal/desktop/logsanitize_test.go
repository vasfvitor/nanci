...
func TestSanitizeLogContent(t *testing.T) {
	tests := []struct {
		...
		{name: "nfse key masks inscricao slot", in: "chave=35503082212345678000195000000000123202409123456789 ok", want: "chave=35503082212.***.***/****-95000000000123202409123456789 ok"},
		{name: "nfse key with cpf slot", in: "chNFSe=35503082100012345678901000000000123202409123456789", want: "chNFSe=35503082100.***.***/****-01000000000123202409123456789"},
		{name: "51 digits untouched", in: "135503082212345678000195000000000123202409123456789", want: "135503082212345678000195000000000123202409123456789"},
		...
		{name: "cte key masks cnpj slot", in: "chCTe=35240112345678000195570010000001231234567890 ok", want: "chCTe=35240112.***.***/****-95570010000001231234567890 ok"},
