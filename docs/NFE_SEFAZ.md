...
- `nfe manifestar` também é simulação sem `--confirmar`.
...
- `nfe_manifestations`: registro de cada envio de manifestação (lote, resultado, `cStat`, `xMotivo`, protocolo), inclusive falhas, para auditoria.
